  ...
  try {
    ...
    return NextResponse.json({
      ...
      deepfake: result.deepfake ? {
        ...
        faceSwapDetected: result.deepfake.faceSwapDetected,
        voiceCloneDetected: result.deepfake.voiceCloneDetected,
        lipSyncDetected: result.deepfake.lipSyncDetected,
        manipulationAreas: result.deepfake.manipulationAreas || [],
        details: result.deepfake.details,
        riskLevel: result.deepfake.riskLevel,
      } : null,
