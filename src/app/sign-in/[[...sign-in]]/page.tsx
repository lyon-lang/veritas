      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 to-blue-700 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative max-w-md text-white">
          ...
          <p className="text-blue-100 mb-10 leading-relaxed">
            Sign in to continue verifying content and protecting yourself from misinformation.
          </p>
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: Eye, text: 'Detect AI-generated content' },
            ].map((feature, i) => (
              <div key={i} className="flex items-center gap-4 bg-white/10 rounded-xl p-4 backdrop-blur-sm">
          ...
          <div className="mt-10 bg-white/10 rounded-xl p-6 backdrop-blur-sm">
            ...
            <p className="text-sm text-blue-100 mb-4">
              &ldquo;The browser extension catches deepfakes I would have missed. Incredible accuracy.&rdquo;
            </p>
            <div>
              <div className="font-medium text-white">Michael Rodriguez</div>
              <div className="text-sm text-blue-200">Security Analyst, CyberGuard</div>
            </div>
          </div>
        </div>
      </div>
